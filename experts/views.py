...
from experts.models import Human, Competence, Mission, Formation, Langue, Loisir, Typecompte, Entreprise
...
def routeur(request):	
    ...
    if currentuser.user.typecompte.typedecompte == "Expert":
        return HttpResponseRedirect(reverse(acceuil))
    else:
	    return HttpResponseRedirect(reverse(profilentreprise))
