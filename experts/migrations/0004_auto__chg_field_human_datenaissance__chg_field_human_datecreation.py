...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Human.datenaissance'
        db.alter_column('experts_human', 'datenaissance', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Human.datecreation'
        db.alter_column('experts_human', 'datecreation', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Human.datenaissance'
        db.alter_column('experts_human', 'datenaissance', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Human.datecreation'
        db.alter_column('experts_human', 'datecreation', self.gf('django.db.models.fields.CharField')(max_length=255))
