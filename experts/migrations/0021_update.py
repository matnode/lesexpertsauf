...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offre.reference'
        db.add_column('experts_offre', 'reference',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=200),
                      keep_default=False)

        # Adding field 'Offre.intitule'
        db.add_column('experts_offre', 'intitule',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'Offre.typeoffre'
        db.add_column('experts_offre', 'typeoffre',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offre.reference'
        db.delete_column('experts_offre', 'reference')

        # Deleting field 'Offre.intitule'
        db.delete_column('experts_offre', 'intitule')

        # Deleting field 'Offre.typeoffre'
        db.delete_column('experts_offre', 'typeoffre')
