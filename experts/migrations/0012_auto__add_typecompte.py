...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Typecompte'
        db.create_table('experts_typecompte', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('typedecompte', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('experts', ['Typecompte'])


    def backwards(self, orm):
        # Deleting model 'Typecompte'
        db.delete_table('experts_typecompte')
