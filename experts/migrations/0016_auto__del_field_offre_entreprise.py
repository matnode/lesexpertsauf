...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Offre.entreprise'
        db.delete_column('experts_offre', 'entreprise_id')


    def backwards(self, orm):
        # Adding field 'Offre.entreprise'
        db.add_column('experts_offre', 'entreprise',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 9, 6, 0, 0), to=orm['experts.Entreprise']),
                      keep_default=False)
