...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Offre'
        db.create_table('experts_offre', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entreprise', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experts.Entreprise'])),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('intitule', self.gf('django.db.models.fields.TextField')()),
            ('ville', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('region', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('secteuractivite', self.gf('django.db.models.fields.TextField')()),
            ('mission', self.gf('django.db.models.fields.TextField')()),
            ('typedecontra', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('periodaffichage', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('grillesalaire', self.gf('django.db.models.fields.TextField')(max_length=255)),
            ('datelimite', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('dureecontrat', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('dateprisefonction', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('experts', ['Offre'])

        # Adding model 'Entreprise'
        db.create_table('experts_entreprise', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('nom', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('datedefondation', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('codepostale', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('ville', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('taille', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('siteweb', self.gf('django.db.models.fields.TextField')()),
            ('telephone', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('adresse', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('activite', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('experts', ['Entreprise'])


    def backwards(self, orm):
        # Deleting model 'Offre'
        db.delete_table('experts_offre')

        # Deleting model 'Entreprise'
        db.delete_table('experts_entreprise')
    ...
    models = {
        ...
        'experts.offre': {
            ...
            'datelimite': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'grillesalaire': ('django.db.models.fields.TextField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intitule': ('django.db.models.fields.TextField', [], {}),
            'mission': ('django.db.models.fields.TextField', [], {}),
            'periodaffichage': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
