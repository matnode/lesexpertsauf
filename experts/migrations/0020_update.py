...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offre.datedebut'
        db.add_column('experts_offre', 'datedebut',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=200),
                      keep_default=False)

        # Adding field 'Offre.datefin'
        db.add_column('experts_offre', 'datefin',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offre.datedebut'
        db.delete_column('experts_offre', 'datedebut')

        # Deleting field 'Offre.datefin'
        db.delete_column('experts_offre', 'datefin')
