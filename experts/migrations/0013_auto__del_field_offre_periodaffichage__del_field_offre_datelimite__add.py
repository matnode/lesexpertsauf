...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Offre.periodaffichage'
        db.delete_column('experts_offre', 'periodaffichage')

        # Deleting field 'Offre.grillesalaire'
        db.delete_column('experts_offre', 'grillesalaire')

        # Deleting field 'Offre.datelimite'
        db.delete_column('experts_offre', 'datelimite')

        # Adding field 'Offre.datedebutaffichage'
        db.add_column('experts_offre', 'datedebutaffichage',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=255),
                      keep_default=False)

        # Adding field 'Offre.datefinaffichage'
        db.add_column('experts_offre', 'datefinaffichage',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=255),
                      keep_default=False)

        # Adding field 'Offre.salairemin'
        db.add_column('experts_offre', 'salairemin',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=200),
                      keep_default=False)

        # Adding field 'Offre.salairemax'
        db.add_column('experts_offre', 'salairemax',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Offre.periodaffichage'
        db.add_column('experts_offre', 'periodaffichage',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=255),
                      keep_default=False)

        # Adding field 'Offre.grillesalaire'
        db.add_column('experts_offre', 'grillesalaire',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=255),
                      keep_default=False)

        # Adding field 'Offre.datelimite'
        db.add_column('experts_offre', 'datelimite',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2015, 9, 3, 0, 0), max_length=255),
                      keep_default=False)

        # Deleting field 'Offre.datedebutaffichage'
        db.delete_column('experts_offre', 'datedebutaffichage')

        # Deleting field 'Offre.datefinaffichage'
        db.delete_column('experts_offre', 'datefinaffichage')

        # Deleting field 'Offre.salairemin'
        db.delete_column('experts_offre', 'salairemin')

        # Deleting field 'Offre.salairemax'
        db.delete_column('experts_offre', 'salairemax')
    ...
    models = {
        ...
        'experts.offre': {
            ...
            'datedebutaffichage': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'datefinaffichage': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'dateprisefonction': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'dureecontrat': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            ...
            'typedecontra': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'ville': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        'experts.typecompte': {
