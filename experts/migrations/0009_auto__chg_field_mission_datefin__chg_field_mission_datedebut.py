...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mission.datefin'
        db.alter_column('experts_mission', 'datefin', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Mission.datedebut'
        db.alter_column('experts_mission', 'datedebut', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Mission.datefin'
        db.alter_column('experts_mission', 'datefin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Mission.datedebut'
        db.alter_column('experts_mission', 'datedebut', self.gf('django.db.models.fields.DateTimeField')())
