...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.competenceutilisee'
        db.add_column('experts_mission', 'competenceutilisee',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2015, 8, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.competenceutilisee'
        db.delete_column('experts_mission', 'competenceutilisee')
