...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Human.codepostale'
        db.alter_column('experts_human', 'codepostale', self.gf('django.db.models.fields.TextField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Human.codepostale'
        db.alter_column('experts_human', 'codepostale', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'experts.human': {
            ...
            'codepostale': ('django.db.models.fields.TextField', [], {'max_length': '200'}),
