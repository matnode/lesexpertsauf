...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offre.contactoffre'
        db.add_column('experts_offre', 'contactoffre',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'Offre.description'
        db.add_column('experts_offre', 'description',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'Offre.mission'
        db.add_column('experts_offre', 'mission',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offre.contactoffre'
        db.delete_column('experts_offre', 'contactoffre')

        # Deleting field 'Offre.description'
        db.delete_column('experts_offre', 'description')

        # Deleting field 'Offre.mission'
        db.delete_column('experts_offre', 'mission')
