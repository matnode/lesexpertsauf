...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offre.secteuractivite'
        db.add_column('experts_offre', 'secteuractivite',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offre.secteuractivite'
        db.delete_column('experts_offre', 'secteuractivite')
