...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Formation.datefin'
        db.alter_column('experts_formation', 'datefin', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Formation.datedebut'
        db.alter_column('experts_formation', 'datedebut', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Formation.datefin'
        db.alter_column('experts_formation', 'datefin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Formation.datedebut'
        db.alter_column('experts_formation', 'datedebut', self.gf('django.db.models.fields.DateTimeField')())
